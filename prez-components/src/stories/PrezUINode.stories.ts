...
export const NodeCurieLabel: Story = {
    args: {
        term: node({value: "http://abc.com/fred", curie: "abc:fred", label: literal("ABC")})
    }
};

export const NodeDescription: Story = {
    args: {
        term: node({value: "http://abc.com/fred", description: literal("The ABC Shop")})
    }
};

export const NodeCurieDescription: Story = {
    args: {
        term: node({value: "http://abc.com/fred", curie: "abc:fred", description: literal("The ABC Shop")})
    }
};
