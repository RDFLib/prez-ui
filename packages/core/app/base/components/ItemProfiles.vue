...
<template>
    <div id="profile-nav" class="ml-0 pt-4 border-l pl-10 pb-10">
        <div>
            <div class="text-xl">
                <ItemLink :to="`?${uriComponent}_profile=altr-ext:alt-profile`">
                    Alternate Profiles
                </ItemLink>
                    ...
                    <div class="pt-2">
                        ...
                        <ul class="text-sm">
                            <li class="mediatypes" v-for="mediatype in profile.mediatypes" :key="mediatype.mediatype">
                                - <ItemLink :to="`${apiUrl}?${uriComponent}_profile=${encodeURIComponent(profile.token)}&_mediatype=${encodeURIComponent(mediatype.mediatype)}`" variant="item-profiles" target="_blank" rel="noopener noreferrer">
