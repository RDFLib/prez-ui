...
const API_BASE_URL = 'https://prezv4-with-fuseki.sgraljii8d3km.ap-southeast-2.cs.amazonlightsail.com';
...
function setupConcepts() {
    document.querySelector<HTMLButtonElement>("#conceptsStaticButton")!.addEventListener("click", async () => {
...
document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
    ...
    <div>
        ...
        <button id="conceptsButton">Get concepts</button>
