<template>  
    <NuxtLayout contentonly sidepanel>
        <template #default>
            <h1 class="text-2xl mt-8">About Prez</h1>
            ...
            <p class="mt-8">Each enabled flavour will have links to its home page in the main menu.</p>
