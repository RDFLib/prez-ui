  ...
  <DataTable v-if="list" striped-rows :value="list" table-style="min-width: 50rem">
    <Column>
      ...
      <template #body="slotProps">
        <PrezUITerm :term="slotProps.data" variant="list-header" />
      </template>
    </Column>
    <Column>
      <template #header>
      ...
      <template #body="slotProps">
        <PrezUITerm v-if="slotProps.data.description" :term="slotProps.data.description" variant="list" />
      </template>
    </Column>
    <Column
    ...
    >
      <template #header>
        <b><PrezUITerm :term="col.predicate" /></b>
      </template>
      <template #body="slotProps">
        <PrezUITerm 
