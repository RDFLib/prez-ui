...
import type { PrezNode, PrezData, PrezFocusNode, PrezConceptNode } from "prez-lib";
import { getItem, getList, search } from "prez-lib";
import type { PrezUIDataProviderProps } from '../types';
...
<template>
    <template v-if="loading">
        <slot name="loading">
            <PrezUILoading :variant="loadingVariant"/>
        </slot>
    </template>
