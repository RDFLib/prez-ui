...
const props = withDefaults(defineProps<DataProviderProps>(), {
    _components: () => {
        return {
            loading: Loading,
            message: Message,
...
<template>
    ...
    <template v-if="loading">
        <slot name="loading">
            <component :is="props._components.loading" :variant="loadingVariant"/>
        </slot>
    </template>
    <template v-else-if="error">
        <slot name="error" :error="error">
            <component :is="props._components.message" severity="error" :text="error.message" />
        </slot>
    </template>
