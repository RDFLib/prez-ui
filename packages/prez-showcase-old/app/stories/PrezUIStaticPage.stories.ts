...
import { PrezUIStaticPage } from "prez-components";
...
export const ExampleStaticPage = createStory({variant: 'stacked'}, { PrezUIStaticPage }, `
...
export const ExampleAboutPage = createStory({variant: 'sidebar'}, { PrezUIStaticPage }, `
